...
#
# build.tcl: Tcl script for re-creating project 'hdmi_through'
#
# Generated by Vivado on Sun Mar 20 16:30:36 +0100 2022
...
#
#    "C:/Users/Michael/Documents/vivado_projects/hdmi_through/hdmi_through.srcs/sources_1/bd/design_1/design_1.bd"
#    "C:/Users/Michael/Documents/vivado_projects/hdmi_through/hdmi_through.srcs/constrs_1/imports/Downloads/Arty-Z7-20-Master.xdc"
#    "C:/Users/Michael/Documents/vivado_projects/hdmi_through/hdmi_through.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
# "[file normalize "$origin_dir/../../Documents/vivado_projects/hdmi_through/hdmi_through.srcs/sources_1/bd/design_1/design_1.bd"]"\
 "[file normalize "$origin_dir/src/constrs/Arty-Z7-20-Master.xdc"]"\
# "[file normalize "$origin_dir/../../Documents/vivado_projects/hdmi_through/hdmi_through.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
 ...
 # set paths [list \
 #"[file normalize "$origin_dir/../../AppData/Roaming/Xilinx/FPGA_IP_Library"]"]"\
 # ]
 # foreach ipath $paths {
...
set _xil_proj_name_ "SIMPLE_HDMI_OUTPUT"
...
#set orig_proj_dir "[file normalize "$origin_dir/../../Documents/vivado_projects/hdmi_through"]"
...
# Create project
create_project SIMPLE_HDMI_OUTPUT $origin_dir/SIMPLE_HDMI_OUTPUT -part xc7z020clg400-1
...
#  import_files -fileset sources_1 [file normalize "${origin_dir}/../../Documents/vivado_projects/hdmi_through/hdmi_through.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
#} else {
...
#set_property -name "incremental_checkpoint" -value "$proj_dir/hdmi_through.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/hdmi_through.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/hdmi_through.srcs/utils_1/imports/impl_1" -objects $obj
